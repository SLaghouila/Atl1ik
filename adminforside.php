...
<center>Velkommen
<br>
<input type="button" value="Hent deltageroplysninger" style="width:190px;"> <br>
<input type="button" value="Rediger deltageroplysninger" style="width:190px;"> <br>
<input type="button" value="rediger runder" style="width:190px;"> <br>
<input type="button" value="Start ny baneturnering" style="width:190px;"></center>
